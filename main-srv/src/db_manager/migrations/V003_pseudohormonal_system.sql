...
INSERT INTO state.settings (param_name, value_float, value_text, value_json, description) VALUES
    ...
    ('tau_cortisol_sec',   5400.0, NULL, NULL, 'Время затухания кортизола в секундах. Определяет, как быстро стресс снижается после события.'),
    ('tau_dopamine_sec',   900.0,  NULL, NULL, 'Время затухания дофамина в секундах. Влияет на скорость угасания мотивации.'),
    ('tau_oxytocin_sec',   500.0, NULL, NULL, 'Время затухания окситоцина в секундах. Долгий спад социального доверия.'),
    ('phs_hourly_drift_interval_sec', 3600.0, NULL, NULL, 'Интервал ежечасного дрейфа baseline в секундах'),
    ('baseline_ou_speed', 0.15, NULL, NULL, 'Скорость возврата baseline к уставке при естественном дрейфе (OU-процесс). 
    ...
    -- Уставки (setpoint)
    ('cortisol_setpoint',  50.0,   NULL, NULL, 'Базовый уровень кортизола в состоянии покоя. Нормальный фон стресса.'),
    ('dopamine_setpoint',  30.0,   NULL, NULL, 'Базовый уровень дофамина при отсутствии внешних стимулов.'),
    ('oxytocin_setpoint',  20.0,   NULL, NULL, 'Базовый уровень окситоцина – комфортный уровень социальной близости.'),
    ('valence_sensitivity', 0.015, NULL, NULL, 'Коэффициент чувствительности валентности: valence = tanh(sensitivity * (dopamine + oxytocin - cortisol)) * 100'),
    ('baseline_drift_noise', 0.3, NULL, NULL, 'Масштаб случайного шума при естественном дрейфе baseline (OU-процесс).'),
    -- Физиологические минимумы и параметры дрейфа
    ('min_cortisol', 5.0, NULL, NULL, 'Минимальный естественный уровень кортизола. Дрейф не опускает ниже этого значения.'),
    ('min_dopamine', 10.0, NULL, NULL, 'Минимальный естественный уровень дофамина. Дрейф не опускает ниже этого значения.'),
    ('min_oxytocin', 10.0, NULL, NULL, 'Минимальный естественный уровень окситоцина. Дрейф не опускает ниже этого значения.'),
...
COMMENT ON COLUMN state.baseline_phs.valence IS 'Валентность (-100..100) = tanh(0.05*(dopa+oxy-cort))*100';
