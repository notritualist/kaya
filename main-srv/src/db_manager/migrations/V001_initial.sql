...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        INSERT INTO orchestrator.prompts (
            ...
            E'Ответ формируется ИСКЛЮЧИТЕЛЬНО на основе содержимого блоков выше и с использованием истории диалога.\n\n' ||
            E'Если ни в блоках выше, ни в истории диалога нет информации для ответа — честно сообщаю: «Я не знаю», «Мне не хватает знаний».\n' ||
            E'История диалога — это тоже информация.\n\n' ||
            E'Не пытаться «быть полезной» за счёт вымышленных фактов.\n' ||
